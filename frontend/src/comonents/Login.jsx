...
const Login = () => {
  ...
  return (
    <>
<div className=" overflow-hidden min-h-screen my-5  bg-gray-100 text-gray-900 flex justify-center w-full p-10 ">
        <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1 ">
                ...
                <div className="mt-1 flex flex-col items-center">
                    <div className="w-full flex-1 mt-2">
                        ...
                        <div className="my-2 border-b text-center">
                            <div
                                className="leading-none px-8 inline-block text-sm text-gray-600 tracking-wide font-medium bg-white transform translate-y-1/2">
                        ...
                        <div className="mx-auto max-w-xs">
                            ...
                            <input className="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5"
                                    id="password" value={user.password} onChange={(e)=>setUser({ ...user,
            ...
            <div className="m-8 xl:m-16 w-full bg-contain bg-center bg-no-repeat"
